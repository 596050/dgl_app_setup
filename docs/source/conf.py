...
latex_documents = [
    (master_doc, 'myapp.tex', 'MyApp Documentation',
     'DGL Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'myapp', 'MyApp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'myapp', 'MyApp Documentation',
     author, 'myapp', 'Application library for XXXXXXXXXXXXXXXX.',
     'Miscellaneous'),
]
